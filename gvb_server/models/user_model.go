...
type UserModel struct {
	...
	Role       ctype2.Role        `gorm:"size:4;default:1" json:"role"`        // 权限  1 管理员  2 普通用户  3 游客
	SignStatus ctype2.LoginMethod `gorm:"type=smallint(6)" json:"sign_status"` // 注册来源
	Scope      int                `json:"scope"`                               // 用户积分
}
